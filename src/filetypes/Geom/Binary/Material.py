...
class MaterialBinary(DSCSSerializable):
    """
    ...
    def exbip_rw(self, rw):
        ...
        self.shader_uniforms = rw.rw_dynamic_objs(self.shader_uniforms, ShaderUniformBinary, self.shader_uniform_count)
        self.opengl_settings = rw.rw_dynamic_objs(self.opengl_settings, OpenGLSettingBinary, self.opengl_setting_count)


class ShaderUniformBinary(DSCSSerializable):
    def __init__(self):
        super().__init__()
        self.payload = None
        self.index = None
...
class OpenGLSettingBinary(DSCSSerializable):
    def __init__(self):
        super().__init__()
        self.payload = None
        self.index = None
