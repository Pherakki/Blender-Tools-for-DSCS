...
from ..object import TempSwapActiveObject, TempSwapActiveObjectMode
...
def resize_bone_lengths(bpy_armature_object, default_size, min_bone_length):
    with TempSwapActiveObject(bpy_armature_object), TempSwapActiveObjectMode("EDIT"):
        for editbone in bpy_armature_object.data.edit_bones:
            resize_bone_length(editbone, default_size, min_bone_length)
